...
const TOOLS = [
  ...
  { id: 'remove-watermark', title: 'Remove Watermark', category: 'pdf', group: 'Pages', icon: I.wand, status: 'soon',
    comingSoonNote: 'We’re polishing this one up to make sure it never touches anything other than the watermark. Check back soon.',
